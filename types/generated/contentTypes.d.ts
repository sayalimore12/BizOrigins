...
export interface ApiAboutUsAboutUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    our_impact: Schema.Attribute.Component<'our-impact.about-us', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    what_makes_us_different: Schema.Attribute.Component<
...
export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contact_des: Schema.Attribute.String;
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    banner_image: Schema.Attribute.Media<'images' | 'files', true>;
    choose_us_des: Schema.Attribute.Text;
    choose_us_title: Schema.Attribute.String;
    confidence_backed_by_know_how: Schema.Attribute.String;
    Confidence_backed_by_know_how_des: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ready_to_start: Schema.Attribute.String;
    tagline: Schema.Attribute.String;
    testimonial_1: Schema.Attribute.Text;
    testimonial_1_jane: Schema.Attribute.String;
    testimonial_2: Schema.Attribute.Text;
    testimonial_2_carlos: Schema.Attribute.String;
    testimonial_3: Schema.Attribute.Text;
    testimonial_3_alice: Schema.Attribute.String;
    title_heading: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    what_our_clients_say: Schema.Attribute.String;
...
export interface ApiNavbarNavbar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    black_logo: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiResourceResource extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resources_desc: Schema.Attribute.String;
